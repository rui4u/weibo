...
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.sharui.Rui__" in the application's documents Application Support directory.
...
//        let modelURL = NSBundle.mainBundle().URLForResource("Rui__", withExtension: "momd")!
